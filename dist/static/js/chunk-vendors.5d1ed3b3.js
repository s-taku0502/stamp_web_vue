"use strict";(self["webpackChunkstamp_web"]=self["webpackChunkstamp_web"]||[]).push([[504],{433:(e,t)=>{t.A=(e,t)=>{const n=e.__vccOpts||e;for(const[r,i]of t)n[r]=i;return n}},743:(e,t,n)=>{n.d(t,{Am:()=>j,FA:()=>N,Fy:()=>b,I9:()=>V,Im:()=>$,Ku:()=>Y,T9:()=>v,Tj:()=>g,Uj:()=>c,XA:()=>y,ZQ:()=>_,bD:()=>F,c1:()=>I,cY:()=>w,dM:()=>R,eX:()=>P,g:()=>x,hp:()=>B,jZ:()=>E,lT:()=>A,lV:()=>C,nr:()=>k,p9:()=>J,sr:()=>S,tD:()=>H,u:()=>l,yU:()=>m,zW:()=>O});
/**
 * @license
 ...
 * limitations under the License.
 */
const J=F;function Y(e,t={}){let n=e;if("object"!==typeof t){const e=t;t={name:e}}const i=Object.assign({name:U,automaticDataCollectionEnabled:!1},t),o=i.name;if("string"!==typeof o||!o)throw Q.create("bad-app-name",{appName:String(o)});if(n||(n=(0,s.T9)()),!n)throw Q.create("no-options");const a=V.get(o);if(a){if((0,s.bD)(n,a.options)&&(0,s.bD)(i,a.config))return a;throw Q.create("duplicate-app",{appName:o})}const c=new r.h1(o);for(const r of H.values())c.addComponent(r);const l=new X(n,i,c);return V.set(o,l),l}function Z(e=U){const t=V.get(e);if(!t&&e===U&&(0,s.T9)())return Y();if(!t)throw Q.create("no-app",{appName:e});return t}function ee(e,t,n){var i;let s=null!==(i=j[e])&&void 0!==i?i:e;n&&(s+=`-${n}`);const o=s.match(/\s|\//),a=t.match(/\s|\//);if(o||a){const e=[`Unable to register library "${s}" with version "${t}":`];return o&&e.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&a&&e.push("and"),a&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void h.warn(e.join(" "))}z(new r.uA(`${s}-version`,(()=>({library:s,version:t})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L=new Map;function $(e,t){const n=M(e);F(n,t),U(n,t)}function F(e,t){const n=L.get(e);if(n)for(const r of n)r(t)}function U(e,t){const n=V();n&&n.postMessage({key:e,fid:t}),B()}let j=null;function V(){return!j&&"BroadcastChannel"in self&&(j=new BroadcastChannel("[Firebase] FID Change"),j.onmessage=e=>{F(e.data.key,e.data.fid)}),j}function B(){0===L.size&&j&&(j.close(),j=null)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Me={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function Le(e){Me=e}function $e(e){return Me.loadJS(e)}function Fe(){return Me.recaptchaEnterpriseScript}function Ue(){return Me.gapiScript}function je(e){return`__${e}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ir=new A(3e4,6e4);function sr(){const e=rn().___jsl;if(null===e||void 0===e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let n=0;n<e.CP.length;n++)e.CP[n]=null}function or(e){return new Promise(((t,n)=>{var r,i,s;function o(){sr(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{sr(),n(g(e,"network-request-failed"))},timeout:ir.get()})}if(null===(i=null===(r=rn().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=rn().gapi)||void 0===s?void 0:s.load)){const t=je("iframefcb");return rn()[t]=()=>{gapi.load?o():n(g(e,"network-request-failed"))},$e(`${Ue()}?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw ar=null,e}))}let ar=null;function cr(e){return ar=ar||or(e),ar}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yt{constructor(e,t=null,n=[],r=[],i=null,s=null,o=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=r,this.limit=i,this.startAt=s,this.endAt=o,this.ue=null}}function wt(e,t=null,n=[],r=[],i=null,s=null,o=null){return new yt(e,t,n,r,i,s,o)}function bt(e){const t=R(e);if(null===t.ue){let e=t.path.canonicalString();null!==t.collectionGroup&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map((e=>at(e))).join(","),e+="|ob:",e+=t.orderBy.map((e=>function(e){return e.field.canonicalString()+e.dir}(e))).join(","),ce(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map((e=>je(e))).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map((e=>je(e))).join(",")),t.ue=e}return t.ue}function _t(e,t){if(e.limit!==t.limit)return!1;if(e.orderBy.length!==t.orderBy.length)return!1;for(let n=0;n<e.orderBy.length;n++)if(!et(e.orderBy[n],t.orderBy[n]))return!1;if(e.filters.length!==t.filters.length)return!1;for(let n=0;n<e.filters.length;n++)if(!ct(e.filters[n],t.filters[n]))return!1;return e.collectionGroup===t.collectionGroup&&!!e.path.isEqual(t.path)&&!!Ye(e.startAt,t.startAt)&&Ye(e.endAt,t.endAt)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Un{constructor(e){this.ht=e}}function jn(e){const t=Mn({parent:e.parent,structuredQuery:e.structuredQuery});return"LAST"===e.limitType?Ot(t,t.limit,"L"):t}
/**
 * @license
 * Copyright 2021 Google LLC
 *
